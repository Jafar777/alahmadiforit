        ...
        <div ref={contentRef} className="bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-3xl">
          <div className="flex flex-col md:flex-row items-center gap-8 p-8 md:p-12">
            <div className="flex-shrink-0">
              <div ref={imageRef} className="w-40 h-40 md:w-56 md:h-56 rounded-full overflow-hidden ring-4 ring-[#283593]/20 shadow-lg">
            ...
            <div ref={textRef} className="flex-1 text-center md:text-right">
              <div className="relative">
                <svg className="absolute -top-6 -right-6 w-12 h-12 text-[#283593]/20 hidden md:block" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                </svg>
                <p className="text-xl md:text-2xl text-gray-700 leading-relaxed italic mb-6">
                  {t('ceo_quote')}
                </p>
                <div className="border-t-2 border-[#283593]/20 pt-4">
                  <h3 className="text-2xl font-bold" style={{ background: 'linear-gradient(135deg, #283593, #559fd8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    {t('ceo_name')}
                  </h3>
