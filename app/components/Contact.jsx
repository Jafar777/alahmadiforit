          ...
          <div ref={formRef} className="flex-1 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input type="text" required className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#650bc2] focus:border-transparent transition" placeholder={t('contact_name')} />
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">{t('contact_email')}</label>
                <input type="email" required className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#650bc2] focus:border-transparent transition" placeholder="you@example.com" />
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">{t('contact_message')}</label>
                <textarea rows="5" required className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#650bc2] focus:border-transparent transition" placeholder={t('contact_message')} />
              </div>
              <button
                type="submit"
                ...
                style={{ background: 'linear-gradient(90deg, #660bc2 0%, #d257a7 50%, #d257a7 100%)' }}
              >
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="bg-[#650bc2]/10 p-3 rounded-full">
                    <svg className="w-6 h-6 text-[#650bc2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
