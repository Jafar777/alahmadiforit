...
const translations = {
  ar: {
    ...
    hero_subtitle: 'نصمم مواقع إلكترونية وتطبيقات جوال راقية لتلبية احتياجاتك',
    hero_btn: 'ابدأ الآن',
    // Services
...
service_6_full: 'تقييمات المخاطر واختبار الاختراق والامتثال والمراقبة المستمرة. نحمي أصولك الرقمية بأفضل الممارسات الصناعية.',
    ...
    pricing_cta_message: 'في حال اردت برمجة تطبيقات جوال او مكتبية او مواقع الكترونية تواصل معنا للحصول على عرض سعر',
     offerprice:'احصل على عرض سعر'
  },
  en: {
    // Header
    nav_home: 'Home',
    ...
    // Inside 'en' object (already have, but ensure these keys exist):
service_1_title: 'Enterprise Desktop Apps',
service_1_short: 'Powerful, secure, and scalable desktop solutions',
service_1_full: 'We build robust enterprise-grade desktop applications tailored to your business workflows. Leveraging modern frameworks, our apps offer high performance, offline capabilities, and seamless integration with existing systems.',
service_2_title: 'Web Apps',
service_2_short: 'Cutting-edge web experiences',
service_2_full: 'From responsive SPAs to full-stack platforms, we create fast, accessible, and SEO-friendly web applications. Using React, Next.js, and modern backends, we deliver future-proof solutions.',
service_3_title: 'Mobile Apps',
service_3_short: 'Native and cross-platform mobile excellence',
service_3_full: 'iOS, Android, and cross-platform apps built with Flutter or React Native. We focus on smooth UI/UX, offline sync, push notifications, and app store deployment.',
service_4_title: 'Graphic Design',
service_4_short: 'Visual identity that speaks volumes',
service_4_full: 'Logos, branding, social media graphics, and marketing materials. Our designs are modern, memorable, and aligned with your brand voice.',
service_5_title: 'Cloud Transformation',
service_5_short: 'Scale with cloud-native strategies',
service_5_full: 'We help you migrate, optimize, and manage cloud infrastructure (AWS, Azure, GCP). From serverless to containers, we ensure cost-efficiency and resilience.',
service_6_title: 'Cyber Security',
service_6_short: 'Protect what matters most',
service_6_full: 'Risk assessments, penetration testing, compliance, and ongoing monitoring. We safeguard your digital assets with industry‑best practices.',
    // Pricing
    ...
    pricing_cta_message: 'If you want to develop mobile, desktop, or web applications, contact us to get a quote.',
    offerprice:'Get a price offer from us'
  }
};
